...
// MINFUTURE change. Commentint out unwanted code to avoid dependency on QueuedImmediateExecutor
...
// MINFUTURE change. Commentint out unwanted code to avoid dependency on QueuedImmediateExecutor
  ...
  return std::vector<Future<Result>>();
}
...
// MINFUTURE change :: Wait functionality brings dependencies on sharedmutex and a bunch of transitive dependencies.
template <class FutureType, typename T = typename FutureType::value_type>
